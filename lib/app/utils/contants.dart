class Constants {
  ...
  static const errorMessage = "Failed to load data";
  static const bookMarkMoviesBox = "BookMarkMovies";
  static const posterPathUrl = "https://image.tmdb.org/t/p/original";
}
